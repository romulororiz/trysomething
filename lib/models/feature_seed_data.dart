...
class FeatureSeedData {
  ...
  static final List<NearbyUser> nearbyUsers = [
    const NearbyUser(id: 'fake-sarah', name: 'Sarah K.', avatarInitial: 'S', hobbyId: 'pottery', distance: '2.3 km', startedText: 'Started this week'),
    const NearbyUser(id: 'fake-alex', name: 'Alex M.', avatarInitial: 'A', hobbyId: 'bouldering', distance: '0.8 km', startedText: '3 weeks in'),
    const NearbyUser(id: 'fake-priya', name: 'Priya T.', avatarInitial: 'P', hobbyId: 'sourdough', distance: '4.1 km', startedText: 'Started yesterday'),
    const NearbyUser(id: 'fake-tom', name: 'Tom R.', avatarInitial: 'T', hobbyId: 'guitar', distance: '1.5 km', startedText: '2 months in'),
  ];
  ...
  static final List<ScheduleEvent> scheduleEvents = [
    const ScheduleEvent(id: 'ev1', hobbyId: 'pottery', dayOfWeek: 2, startTime: '19:00', durationMinutes: 90),
    const ScheduleEvent(id: 'ev2', hobbyId: 'bouldering', dayOfWeek: 4, startTime: '18:30', durationMinutes: 75),
    const ScheduleEvent(id: 'ev3', hobbyId: 'sourdough', dayOfWeek: 6, startTime: '09:00', durationMinutes: 60),
  ];
  ...
  static final Map<String, List<FaqItem>> faqByHobby = {
    'pottery': [
      const FaqItem(question: 'Do I need a kiln to start?', answer: 'No! Air-dry clay needs no kiln at all. Many studios also offer kiln access for firing.'),
      const FaqItem(question: 'Can I use pottery without firing it?', answer: 'Air-dry clay pieces are functional for dry goods and decoration. For food-safe use, you\'ll need to glaze and fire.'),
      const FaqItem(question: 'How long does it take to get good?', answer: 'You can make satisfying pieces in your first session. "Good" is subjective — enjoy the process!'),
    ],
    'bouldering': [
      const FaqItem(question: 'Do I need to be strong to start?', answer: 'Not at all! Technique matters far more than strength. Most V0-V1 problems require balance, not power.'),
      const FaqItem(question: 'Will my fingers hurt?', answer: 'Yes, initially. Your skin toughens within 2-3 weeks. Avoid over-gripping and take rest days.'),
      const FaqItem(question: 'Should I buy shoes right away?', answer: 'Rent for your first 3-4 sessions. If you keep going, invest in beginner shoes (La Sportiva Tarantula is great).'),
    ],
    'sourdough': [
      const FaqItem(question: 'Can I use regular flour for sourdough?', answer: 'Yes, but bread flour gives better results due to higher protein. Whole wheat works great for starters.'),
      const FaqItem(question: 'My starter won\'t rise. Is it dead?', answer: 'Probably not! It can take 10-14 days in cold environments. Feed consistently and keep it warm (24-26°C ideal).'),
      const FaqItem(question: 'Why is my bread flat?', answer: 'Common causes: under-proofed, weak starter, not enough steam in oven, or cutting too soon after baking.'),
    ],
    'chess': [
      const FaqItem(question: 'Which app should I use?', answer: 'Chess.com and Lichess are both excellent. Lichess is 100% free. Chess.com has better lessons for beginners.'),
      const FaqItem(question: 'How do I stop losing every game?', answer: 'Focus on not hanging pieces (free captures for your opponent). Check every move for safety before you play it.'),
      const FaqItem(question: 'Should I learn openings?', answer: 'Not yet! Learn tactics first (forks, pins, skewers). Opening knowledge is useless without tactical vision.'),
    ],
    'guitar': [
      const FaqItem(question: 'Acoustic or electric for beginners?', answer: 'Acoustic is cheaper and more portable. Electric is easier on fingers. Choose based on the music you love.'),
      const FaqItem(question: 'How long until I can play a song?', answer: 'With 15 min/day practice, you can play a simple 2-chord song in about 1-2 weeks.'),
      const FaqItem(question: 'My fingers hurt. Is this normal?', answer: 'Completely normal! Calluses form in 2-3 weeks. Take short breaks but practice daily for best adaptation.'),
    ],
  };
  ...
  static final Map<String, CostBreakdown> costByHobby = {
    'pottery': const CostBreakdown(starter: 35, threeMonth: 125, oneYear: 380, tips: [
    ...
    'calligraphy': const CostBreakdown(starter: 23, threeMonth: 40, oneYear: 80, tips: [
    ...
    'hiking': const CostBreakdown(starter: 95, threeMonth: 100, oneYear: 150, tips: [
    ...
    'skateboarding': const CostBreakdown(starter: 110, threeMonth: 130, oneYear: 200, tips: [
