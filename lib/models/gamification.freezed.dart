...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, description: $description, icon: $icon, unlockedAt: $unlockedAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, icon, unlockedAt);
