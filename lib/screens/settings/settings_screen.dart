              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    // Vibes
                    const SectionLabel(text: 'YOUR VIBES'),
                    const SizedBox(height: 12),
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                    ...
                    // ── Session ──
                    const SizedBox(height: 20),
                    const SectionLabel(text: 'SESSION'),
                    const SizedBox(height: 12),
                    ...
                    if (kDebugMode) ...[
                      const SizedBox(height: 8),
                      const SectionLabel(text: 'DEBUG'),
                      const SizedBox(height: 12),
                      const DebugProToggle(),
