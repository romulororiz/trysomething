...
export async function sendVerificationEmail(
	...
	await resend.emails.send({
		from: 'TrySomething <no-reply@trysomething.io>',
		to: email,
...
export async function sendPasswordResetEmail(
	...
	await resend.emails.send({
		from: 'TrySomething <no-reply@trysomething.io>',
		to: email,
		subject: `${code} is your TrySomething password reset code`,
		html: `
<!DOCTYPE html>
<html lang="en">
<head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"></head>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:440px;">
        ...
        <tr><td style="background:#0A0A0F;border-radius:20px;border:1px solid #1A1A20;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
            ...
            <!-- Greeting -->
            <tr><td style="padding:36px 32px 0;">
              <p style="margin:0;font-size:24px;font-weight:700;color:#F5F0EB;line-height:1.3;">Reset your password</p>
            </td></tr>

            <!-- Message -->
            <tr><td style="padding:12px 32px 0;">
              <p style="margin:0;font-size:15px;color:#B0A89E;line-height:1.6;">
                Hey ${displayName}, we received a request to reset your password. Enter this code in the app to set a new one.
              </p>
            </td></tr>
