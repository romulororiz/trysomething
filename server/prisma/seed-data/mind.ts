...
export const mindFaqItems = [
  ...
  // Puzzles
  { hobbyId: "puzzles", question: "How do I not lose puzzle pieces?", answer: "Work on a flat surface you can dedicate to the puzzle, or invest in a puzzle mat ($15). Keep pieces in a shallow box, never the floor. Check under the sofa.", upvotes: 36 },
...
export const mindCostBreakdowns = [
  ...
  { hobbyId: "journaling", starter: 22, threeMonth: 25, oneYear: 50, tips: ["One notebook lasts 3-6 months depending on how much you write", "Fancy pens are fun but a $2 pen works perfectly", "Journaling is essentially the cost of paper"] },
  ...
  { hobbyId: "puzzles", starter: 15, threeMonth: 40, oneYear: 80, tips: ["Swap completed puzzles with friends or on Facebook groups", "Charity shops sell puzzles for $3-5", "One puzzle gives 5-10 hours of entertainment"] },
  ...
  { hobbyId: "speed-cubing", starter: 10, threeMonth: 15, oneYear: 30, tips: ["A $10 speed cube is all you need to start and compete", "csTimer.net is free and tracks all your statistics", "The cheapest hobby with the highest cool factor"] },
  ...
  { hobbyId: "mind-calligraphy", starter: 28, threeMonth: 40, oneYear: 70, tips: ["Pilot Parallel Pens are the best value calligraphy tool ($10 each)", "Practice paper is the main recurring cost", "Ink cartridges last a long time — refills are cheap"] },
